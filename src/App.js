...
//     return (
//       <div id="main">
//         <button id="click" onClick={() => this.buttonClick()}>
//           Enter
//         </button>
//         {this.state.showMessage && <p id="para">I learned the technice</p>}
//       </div>
//     );
//   }
// }
...
/////////////function Component/////////////////////
// function App() {
//   const [set, Click] = useState("hide");
//   return (
//     <div id="main">
//       <button id="click" onClick={() => Click("show")}>
//         Enter
//       </button>
//       {set === "show" && (
//         <p id="para">
